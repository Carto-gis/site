...
<qgis version="3.36.0-Maidenhead" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" styleCategories="Symbology|Rendering|Legend" minScale="100000000" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" symbologyReferenceScale="-1" maxScale="0">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" graduatedMethod="GraduatedColor" type="graduatedSymbol" symbollevels="0" attr="positivity_score">
    <ranges>
      <range lower="-1.000000000000000" label="-1 - -0.73" render="true" upper="-0.733333333333333" uuid="{10fa1b69-7780-496f-88d9-256bf0fd02e6}" symbol="0"/>
      <range lower="-0.733333333333333" label="-0.73 - -0.2" render="true" upper="-0.200000000000000" uuid="{b09d469b-ee34-487a-808f-244441586a67}" symbol="1"/>
      <range lower="-0.200000000000000" label="-0.2 - 0.27" render="true" upper="0.272727272727273" uuid="{d2ca8617-aeb7-41da-b053-271259cf424c}" symbol="2"/>
      <range lower="0.272727272727273" label="0.27 - 0.73" render="true" upper="0.729729729729730" uuid="{0fbb46c7-06c5-440b-bb92-41eb122d8f63}" symbol="3"/>
      <range lower="0.729729729729730" label="0.73 - 1" render="true" upper="1.000000000000000" uuid="{c18b6be9-5be9-4193-ae50-d82d90072479}" symbol="4"/>
    </ranges>
    <symbols>
      <symbol alpha="1" force_rhr="0" frame_rate="10" type="fill" name="0" is_animated="0" clip_to_extent="1">
        ...
        <layer id="{83e01628-167a-4854-8b44-68d19b44b19b}" locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            ...
            <Option value="151,151,151,156,hsv:0,0,0.59215686274509804,0.61176470588235299" type="QString" name="outline_color"/>
      ...
      <symbol alpha="1" force_rhr="0" frame_rate="10" type="fill" name="1" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" force_rhr="0" frame_rate="10" type="fill" name="2" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" force_rhr="0" frame_rate="10" type="fill" name="3" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" force_rhr="0" frame_rate="10" type="fill" name="4" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" force_rhr="0" frame_rate="10" type="fill" name="" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{6c21fca2-99c3-44df-998e-88e5bc26d108}" locked="0" enabled="1" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
